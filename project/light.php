...
<h6>--/:: by <br></h6><br><br><script>PickImage()</script><script>PickQuote()</script><br></span>
</span>
...
<!-- <div style="position:absolute;left:10%;margin-top:150px;width:80%;min-width:1000px;text-align:center">
...
<!-- 
<div style="position:absolute;left:10%;margin-top:350px;width:80%;min-width:1000px;text-align:center">
<div style="display:inline-block;width:20%;vertical-align:top;">
<div class="info_block" style="display:inline-block;width:100%;padding:15px;">
<table style="padding-left:10px;" cellspacing="10px"> -->
<!-- <tr>
